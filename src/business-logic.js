 ...
 */
const toggleRunning = (state, newState) => {
 ...
 */
const nextFrame = (state, newState) => {
 ...
 */
export const generateRandomCellStates = (rows, columns) => {
  let state = {}
 ...
 */
const countAdjacentCells = (state, row, col) => {
